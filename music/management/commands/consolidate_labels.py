...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--from-label-id", type=int, help="ID of the label to move albums FROM")
        parser.add_argument("--to-label-id", type=int, help="ID of the label to move albums TO")
        parser.add_argument(
            "--list", action="store_true", help="List all record labels with their IDs and album counts"
        )
        parser.add_argument("--delete-old", action="store_true", help="Delete the old label after moving albums")
