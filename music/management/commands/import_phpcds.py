...
class Command(BaseCommand):
    ...
    def import_genres(self):
        ...
        for genre_item in genre_data:
            ...
            if genre_name:
                genre, created = Genre.objects.get_or_create(name=genre_name, defaults={"description": genre_desc})
                if created:
                    count += 1
    ...
    def import_albums(self):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"Imported {album_count} albums, {artist_count} artists, {label_count} labels")
        )
